...
<section id="primary" class="span8">
	...
	<div id="content" role="main">
			...
			tha_entry_before(); ?>
				...
				<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
					...
					<header class="page-header">
						...
						<?php $terms = get_the_terms(get_the_ID(), 'policy_type');
							foreach ($terms as $term)
								$term_name .= $term->name.', ';
								
							echo ' Categories: '. $term_name.'<br />';
						?>
						<?php $terms = get_the_terms(get_the_ID(), 'policy_keywords');
							foreach ($terms as $term)
								$key_name .= $term->name.', ';
		...
		<nav id="nav-single" class="pager">
			...
			<span class="next"><?php next_post_link( '%link', sprintf( '%1$s <span class="meta-nav">&rarr;</span>', __( 'Next Policy', 'the-bootstrap' ) ) ); ?></span>

			<span class="previous"><?php previous_post_link( '%link', sprintf( '<span class="meta-nav">&larr;</span> %1$s', __( 'Previous Policy', 'the-bootstrap' ) ) ); ?></span>
